...
public class PublicTest {
	...
	@Test(expected = ParseException.class)
	public void stopAfterExplicitRead() throws ParseException { testCase("A("); }
	
	@Test(expected = ParseException.class)
	public void stopAfterFirstChild() throws ParseException { testCase("A(-"); }
	
	@Test(expected = ParseException.class)
	public void stopAfterSecondChild() throws ParseException { testCase("A(-,-"); }
}
